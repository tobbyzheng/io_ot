...
// Test
//console.log(app.quaternions[0].q0, q1, q2, q3);
...
//    mahonyAHRSupdate(gx, gy, gz, ax, ay, az, mx, my, mz);
    ...
    //       
    var q = app.quaternions[0];
    app.showInfo("q0="+q.q0+" q1="+q.q1+" q2="+q.q2+" q3="+q.q3);
    cube.quaternion.set(q.q1, q.q2, q.q3, q.q0);

    if ((q.q0 === NaN) || (q.q1 === NaN) || (q.q2 === NaN) || (q.q3 === NaN)) {
